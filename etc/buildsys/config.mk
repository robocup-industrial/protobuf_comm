...
PROTOBUF_COMM_VERSION_MAJOR = $(lastword $(shell grep "\#define PROTOBUF_COMM_VERSION_MAJOR" $(BASEDIR)/src/protobuf_comm/version.h))
PROTOBUF_COMM_VERSION_MINOR = $(lastword $(shell grep "\#define PROTOBUF_COMM_VERSION_MINOR" $(BASEDIR)/src/protobuf_comm/version.h))
PROTOBUF_COMM_VERSION_MICRO = $(lastword $(shell grep "\#define PROTOBUF_COMM_VERSION_MICRO" $(BASEDIR)/src/protobuf_comm/version.h))
DEFAULT_SOVER        = $(PROTOBUF_COMM_VERSION_MAJOR).$(PROTOBUF_COMM_VERSION_MINOR).$(PROTOBUF_COMM_VERSION_MICRO)
PROTOBUF_COMM_VERSION       = $(PROTOBUF_COMM_VERSION_MAJOR).$(PROTOBUF_COMM_VERSION_MINOR).$(PROTOBUF_COMM_VERSION_MICRO)
