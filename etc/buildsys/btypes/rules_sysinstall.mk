...
include $(BUILDSYSDIR)/btypes/rules_protobuf_comm.mk
...
$(foreach P,$(LIBS_all:$(LIBDIR)/lib%.so=%) $(LIBS_gui:$(LIBDIR)/lib%.so=%),$(if $(and $(call not,$(INST_HDRS_SUBDIR_lib$P)),$P),$(eval INST_HDRS_SUBDIR_lib$P = $P)))
