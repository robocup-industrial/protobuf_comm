...
include $(BUILDSYSDIR)/btypes/config_protobuf_comm.mk
...
FFLIBSUBDIR        = protobuf_comm
EXEC_BASEDIR       = $(abspath $(PREFIX))
EXEC_CONFDIR       = $(SYSCONFDIR)
EXEC_RESDIR        = $(EXEC_BASEDIR)/share/protobuf_comm
...
EXEC_DOCDIR        = $(EXEC_BASEDIR)/share/doc/protobuf_comm-$(PROTOBUF_COMM_VERSION)
